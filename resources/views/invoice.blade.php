          ...
          <div class="container mb-5 mt-3">
            ...
            @endforeach
              ...
              <div class="row">
                ...
                <form method="POST" action="{{route('deleteh',['id' => $Alamat->id])}}">
                @csrf
                @method('DELETE')
                            <a href="/viewuser"><button type="button" class="btn btn-outline-primary">Return</button></a>
                </form>        
                </div>
              </div>
